...
def generate_seq_str_data(int_list, seq_feat_dir, full_feat_dir, struct_dir, non_cached_dir, p2=False, min_res_num=11, AF_threshold=0):
    """
    ...
    Args:
        ...
        AF_threshold: pLDDT Threshold for the use of AlphaFold structures.
...
def generate_str_seq_data(int_list, seq_feat_dir, full_feat_dir, struct_dir, non_cached_dir, p2=False, min_res_num=11, AF_threshold=0):
    """
...
def generate_str_str_data(int_list, full_feat_dir, struct_dir, non_cached_dir, min_res_num=11, AF_threshold=0):
    """
